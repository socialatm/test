			...
			*}}
			...
			{{if $localuser || $nav.pubs}}
				<li id="notifyBtn" class="btn btn-primary notifyBtn">
					<a class="nav-link text-white" data-bs-toggle="modal" data-bs-target="#notifyModal"><i class="far fa-bell"></i><span class="float-end badge bg-danger notify-update rounded-circle"></span></a>
				</li>
			{{/if}}
