...
<script src="{{$baseurl}}/library/moment/moment.min.js"></script>
<script src="{{$baseurl}}/library/fullcalendar.old/fullcalendar.min.js"></script>
<script src="{{$baseurl}}/library/fullcalendar.old/locale-all.js"></script>
