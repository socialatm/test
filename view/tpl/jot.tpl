	...
	<div class="mb-4" id="profile-jot-wrapper">
		...
		<div id="profile-jot-submit-wrapper" class="clearfix p-2 jothidden">
			...
			<div id="profile-jot-submit-right" class="btn-group float-end">
				...
				{{/if}}
				{{if $showacl}}
				<button type="button" id="dbtn-acl" class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#aclModal" title="{{$permset}}" data-form_id="profile-jot-form">
